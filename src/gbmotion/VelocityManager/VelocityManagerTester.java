...
public class VelocityManagerTester {
	...
	public VelocityManagerTester(CANRobotDrive drive, Joystick stick, int pastTimeImportance,
		...
		if (gear == RobotStats.Gear.POWER) {
			m_leftEncoderTicksPerRadian = RobotStats.Icarus.EncoderRadianScale.LEFT_POWER.value;
			m_rightEncoderTicksPerRadian = RobotStats.Icarus.EncoderRadianScale.RIGHT_POWER.value;
		} else {
			m_leftEncoderTicksPerRadian = RobotStats.Icarus.EncoderRadianScale.LEFT_VELOCITY.value;
			m_rightEncoderTicksPerRadian = RobotStats.Icarus.EncoderRadianScale.RIGHT_VELOCITY.value;
		}
		m_stick = stick;
