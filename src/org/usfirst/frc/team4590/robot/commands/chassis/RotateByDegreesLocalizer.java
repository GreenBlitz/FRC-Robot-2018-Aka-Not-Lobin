...
//
//public class RotateByDegreesLocalizer extends Command implements PIDSource, PIDOutput {
...
//	
//	public RotateByDegreesLocalizer(double angles){
//		this(angles, true);
//	}
//	
//	public RotateByDegreesLocalizer(double angles, boolean resetGyro) {
...
//		return ((IOrientation2D) Chassis.getInstance().getLocalizer(false).recieve()).getDirection()*180/Math.PI;
//	}
//
//	@Override
