...
public class AutoSwitchMiddle extends CommandChain {
	...
	protected void onFirstRun(){
		...
		Command driveToMiddle = new DriveForwardsByMeters((Lengths.SWITCH_FROM_ALLIANCE_WALL - Lengths.ROBOT_LENGTH) / 2 -0.15),
				...
				driveToPlate = new DriveForwardsByMeters((Lengths.SWITCH_FROM_ALLIANCE_WALL - Lengths.ROBOT_LENGTH) / 2 - 0.25, false, false),
				driveExtra = new ArcadeDriveByValues(0.5, 0, 1000),
