...
public class ReverseAutoSwitchLeft extends CommandChain {

	public ReverseAutoSwitchLeft() {
	...
	public void onFirstRun() {
		Command movePitcher = new MovePitcherToState(PitcherState.SWITCH_BACKWARD),
