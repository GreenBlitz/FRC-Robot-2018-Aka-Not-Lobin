...
public class AutoMiddleLeftSwitchReverse extends CommandChain {

	public AutoMiddleLeftSwitchReverse() {
		Command grabCube = new PickupCube(),
				driveToMiddle = new DriveForwardsByMeters(-((Lengths.SWITCH_FROM_ALLIANCE_WALL - Lengths.ROBOT_LENGTH)/2 + 0.4)),
